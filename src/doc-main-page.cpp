...
/*!
  ...
  The project has some unit tests, see \ref tests.
  ...
  Here is a raw class diagram used as a draw for the project, not exhaustive, not up to date, not true UML
  but gives an overview of classes.
